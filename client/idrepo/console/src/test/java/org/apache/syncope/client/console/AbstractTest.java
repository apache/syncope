...
public abstract class AbstractTest {
    ...
    public static class SyncopeConsoleWebApplicationTestConfig {
        ...
        public ConsoleProperties consoleProperties() {
            ...
            props.getSecurityHeaders().put("X-XSS-Protection", "1; mode=block");
            props.getSecurityHeaders().put("Strict-Transport-Security", "max-age=31536000; includeSubDomains; preload");
            props.getSecurityHeaders().put("X-Content-Type-Options", "nosniff");
            props.getSecurityHeaders().put("X-Frame-Options", "sameorigin");

            props.setAnonymousUser("anonymousUser");
