...
public class ConsoleAnonymousRestClient extends BaseRestClient implements AnonymousRestClient {
    ...
    public boolean isMfaEnrolled(final String username) {
        try {
            return BooleanUtils.toBoolean(SyncopeConsoleSession.get().getAnonymousService(MfaService.class).
