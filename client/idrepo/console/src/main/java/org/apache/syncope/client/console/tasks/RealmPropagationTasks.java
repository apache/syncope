...
public class RealmPropagationTasks extends AbstractPropagationTasks {

    private static final long serialVersionUID = 6384023473496365348L;

    public RealmPropagationTasks(final BaseModal<?> baseModal, final String entityKey, final PageReference pageRef) {
        super(BaseModal.CONTENT_ID);

        MultilevelPanel mlp = new MultilevelPanel("tasks");
        mlp.setFirstLevel(new RealmPropagationTaskDirectoryPanel(
                taskRestClient, baseModal, mlp, entityKey, pageRef) {

            private static final long serialVersionUID = 1045407235404316382L;
