...
public class SchedTaskWizardBuilder<T extends SchedTaskTO> extends BaseAjaxWizardBuilder<T> {
    ...
    protected class Profile extends WizardStep {
        ...
        protected Profile(final SchedTaskTO taskTO) {
            ...
            FieldPanel<Integer> corePoolSize = new AjaxNumberFieldPanel.Builder<Integer>().min(1).build(
                    "corePoolSize",
                    "corePoolSize",
                    Integer.class,
            ...
            FieldPanel<Integer> maxPoolSize = new AjaxNumberFieldPanel.Builder<Integer>().min(1).build(
                    "maxPoolSize",
                    "maxPoolSize",
                    Integer.class,
            ...
            FieldPanel<Integer> queueCapacity = new AjaxNumberFieldPanel.Builder<Integer>().min(1).build(
                    "queueCapacity",
                    "queueCapacity",
                    Integer.class,
