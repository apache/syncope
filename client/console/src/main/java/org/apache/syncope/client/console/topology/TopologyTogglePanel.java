    ...
    private Fragment getConnectorFragment(final TopologyNode node, final PageReference pageRef) {
        ...
        AjaxLink<String> history = new IndicatingAjaxLink<String>("history") {
            ...
            public void onClick(final AjaxRequestTarget target) {
                ...
                historyModal.header(new Model<>(MessageFormat.
                        format(getString("connector.menu.history"), node.getDisplayName())));
    ...
    private Fragment getResurceFragment(final TopologyNode node, final PageReference pageRef) {
        ...
        AjaxLink<String> history = new IndicatingAjaxLink<String>("history") {
            ...
            public void onClick(final AjaxRequestTarget target) {
                ...
                target.
                        add(historyModal.
                                setContent(new HistoryConfList<>(historyModal, resourceKey, pageRef, modelObject)));

                historyModal.header(new Model<>(MessageFormat.
                        format(getString("resource.menu.history"), node.getDisplayName())));
