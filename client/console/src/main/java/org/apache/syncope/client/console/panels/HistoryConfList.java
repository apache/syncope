...
public class HistoryConfList<T extends Serializable> extends Panel implements ModalPanel {
    ...
    public <T extends AnyTO> HistoryConfList(
        ...
        mlp.setFirstLevel(modelObj instanceof ConnInstanceTO ? new ConnInstanceHistoryConfDirectoryPanel(baseModal,
                mlp, entityKey, pageReference) {
            ...
            protected void viewConfiguration(final ConnInstanceHistoryConfTO historyTO,
                ...
                mlp.next(
                        new StringResourceModel("history.diff.view", this, new Model<>(Pair.of(null, historyTO))).
                                getObject(),
                        new HistoryConfDetails<>(modal, historyTO, pageReference,
                                restClient.list(entityKey)), target);
            }
        } : new ResourceHistoryConfMainDirectoryPanel(baseModal, mlp, entityKey, pageReference) {
