...
import org.apache.syncope.client.console.panels.ResourceHistoryConfMainDirectoryPanel.RHConfProvider;
 ...
 */
public abstract class ResourceHistoryConfMainDirectoryPanel extends DirectoryPanel<
    ...
    protected ResourceHistoryConfMainDirectoryPanel(
    ...
    public ActionsPanel<ResourceHistoryConfTO> getActions(final IModel<ResourceHistoryConfTO> model) {
        ...
        panel.add(new ActionLink<ResourceHistoryConfTO>() {
            ...
            public void onClick(final AjaxRequestTarget target, final ResourceHistoryConfTO modelObject) {
                ...
                ResourceHistoryConfMainDirectoryPanel.this.getTogglePanel().close(target);
