...
public class PGJPAJSONAuditEntryDAO extends AbstractJPAJSONAuditEntryDAO {
            ...
            if (!containers.isEmpty()) {
                query.append(andIfNeeded()).append('(').
                        append(containers.stream().
                                map(container -> MESSAGE_COLUMN + "::jsonb @> '"
    ...
    public PGJPAJSONAuditEntryDAO(final EntityManager entityManager) {
        super(entityManager);
    }
