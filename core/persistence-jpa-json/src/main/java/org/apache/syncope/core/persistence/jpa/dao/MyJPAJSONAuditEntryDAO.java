...
public class MyJPAJSONAuditEntryDAO extends AbstractJPAJSONAuditEntryDAO {
            ...
            if (!containers.isEmpty()) {
                query.append(andIfNeeded()).append('(').
                        append(containers.stream().
                                map(container -> "JSON_CONTAINS(" + MESSAGE_COLUMN + ", '"
    ...
    public MyJPAJSONAuditEntryDAO(final EntityManager entityManager) {
        super(entityManager);
    }
