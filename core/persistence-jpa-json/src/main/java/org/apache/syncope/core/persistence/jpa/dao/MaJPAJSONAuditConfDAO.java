        ...
        protected String doBuild(final List<ObjectNode> containers) {
            if (entityKey != null) {
                query.append(andIfNeeded()).append('(').
                        append("JSON_VALUE(").append(AUDIT_ENTRY_MESSAGE_COLUMN).append(", '$.before') LIKE '%").
                        append(entityKey).
                        append("%' OR ").
                        append("JSON_VALUE(").append(AUDIT_ENTRY_MESSAGE_COLUMN).append(", '$.input') LIKE '%").
                        append(entityKey).
                        append("%' OR ").
                        append("JSON_VALUE(").append(AUDIT_ENTRY_MESSAGE_COLUMN).append(", '$.output') LIKE '%").
                        append(entityKey).
                        append("%')");
            }
