...
abstract class ScriptEngineOverloadsMacroActions extends Script implements MacroActions {}
...
StringBuilder afterAll(Map<String, Serializable> ctx, StringBuilder output) {
  ...
  output.append(engine.eval(new java.io.StringReader("'script-engine-reader|'")))
