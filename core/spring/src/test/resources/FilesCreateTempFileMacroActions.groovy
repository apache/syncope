...
abstract class FilesCreateTempFileMacroActions extends Script implements MacroActions {}
@BaseScript FilesCreateTempFileMacroActions _

@Override
StringBuilder afterAll(Map<String, Serializable> ctx, StringBuilder output) {
  def path = java.nio.file.Files.createTempFile('sandbox-files-create-temp-', '.txt')
