    ...
    public <T extends TaskTO> T getTaskTO(final Task task, final TaskUtils taskUtils, final boolean details) {
        ...
        switch (taskUtils.getType()) {
            ...
            case PULL:
                ...
                pullTask.getTemplates()
                    .forEach(template -> pullTaskTO.getTemplates().put(template.getAnyType().getKey(), template.get()));
            ...
            case PUSH:
                ...
                pushTask.getFilters()
                    .forEach(filter -> pushTaskTO.getFilters().put(filter.getAnyType().getKey(), filter.getFIQLCond()));
                break;
