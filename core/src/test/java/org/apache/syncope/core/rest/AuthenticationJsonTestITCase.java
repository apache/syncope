...
public class AuthenticationJsonTestITCase extends AbstractAuthenticationTestITCase {

    @Override
    public void setupService() {
        super.as = createServiceInstance(AuthenticationService.class);
        setupJSON(WebClient.client(super.as));
        super.rs = createServiceInstance(RoleService.class);
        setupJSON(WebClient.client(super.rs));
        super.us = createServiceInstance(UserService.class);
        setupJSON(WebClient.client(super.us));
    }
