...
@Node(Neo4jSecurityQuestion.NODE)
public class Neo4jSecurityQuestion extends AbstractGeneratedKeyNode implements SecurityQuestion {

    private static final long serialVersionUID = 7675321820453579744L;

    public static final String NODE = "SecurityQuestion";
