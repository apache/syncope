...
public class Neo4jGPlainAttrUniqueValue extends AbstractPlainAttrValue implements GPlainAttrUniqueValue {

    private static final long serialVersionUID = -4053996864791245312L;

    @JsonIgnore
    @NotNull
    private Neo4jGPlainAttr attr;
    ...
    public void setAttr(final PlainAttr<?> attr) {
        ...
        this.attr = (Neo4jGPlainAttr) attr;
    }
