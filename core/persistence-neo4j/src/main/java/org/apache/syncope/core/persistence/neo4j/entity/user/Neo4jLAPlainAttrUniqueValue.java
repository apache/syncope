...
public class Neo4jLAPlainAttrUniqueValue extends AbstractPlainAttrValue implements LAPlainAttrUniqueValue {
    ...
    public void setAttr(final PlainAttr<?> attr) {
        ...
        this.attr = (Neo4jLAPlainAttr) attr;
    }
