...
abstract class AbstractCorrelationRuleEntity extends AbstractGeneratedKeyNode implements CorrelationRuleEntity {
    ...
    public void setImplementation(final Implementation implementation) {
        checkType(implementation, Neo4jImplementation.class);
        checkImplementationType(implementation, getImplementationType());
        this.implementation = (Neo4jImplementation) implementation;
    }
}
