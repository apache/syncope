...
@Node(Neo4jUDynGroupMembership.NODE)
public class Neo4jUDynGroupMembership extends AbstractDynMembership<User> implements UDynGroupMembership {

    private static final long serialVersionUID = -7336814163949640354L;

    public static final String NODE = "UDynGroupMembership";
