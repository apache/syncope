...
import org.apache.syncope.core.rest.cxf.service.OIDCOPServiceImpl;
...
public class AMRESTCXFContext {
    ...
    @ConditionalOnMissingBean
    @Bean
    public OIDCOPService oidcOPService(final OIDCOPLogic oidcOPLogic) {
        return new OIDCOPServiceImpl(oidcOPLogic);
    }
