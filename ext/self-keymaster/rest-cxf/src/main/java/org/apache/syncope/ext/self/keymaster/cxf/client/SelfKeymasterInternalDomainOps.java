...
public class SelfKeymasterInternalDomainOps implements DomainOps {
    ...
    public List<Domain> list() {
        return AuthContextUtils.callAs(SyncopeConstants.MASTER_DOMAIN, keymasterUser, Collections.emptyList(), () -> logic.list());
    }

    @Override
    public Domain read(final String key) {
        return AuthContextUtils.callAs(SyncopeConstants.MASTER_DOMAIN, keymasterUser, Collections.emptyList(), () -> logic.read(key));
    }
