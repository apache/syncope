...
public class OpenSearchIndexLoader implements SyncopeCoreLoader {

    protected static final Logger LOG = LoggerFactory.getLogger(OpenSearchIndexLoader.class);

    protected final OpenSearchIndexManager indexManager;

    public OpenSearchIndexLoader(final OpenSearchIndexManager indexManager) {
