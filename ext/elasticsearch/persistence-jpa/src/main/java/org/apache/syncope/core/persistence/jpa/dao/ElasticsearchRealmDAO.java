...
public class ElasticsearchRealmDAO extends JPARealmDAO {
    ...
    public Realm findByFullPath(final String fullPath) {
        ...
        try {
            String result = elasticsearchClient.search(request, Void.class).hits().hits().stream().findFirst().
                    map(Hit::id).
                    orElse(null);
            return find(result);
        } catch (Exception e) {
    ...
    protected List<String> search(final Query query) {
        ...
        try {
            return elasticsearchClient.search(request, Void.class).hits().hits().stream().
                    map(Hit::id).
    ...
    public int countDescendants(final String base, final String keyword) {
        ...
        try {
            return (int) elasticsearchClient.count(request).count();
        } catch (Exception e) {
    ...
    public List<Realm> findDescendants(
        ...
        try {
            result = elasticsearchClient.search(request, Void.class).hits().hits().stream().
                    map(Hit::id).
                    collect(Collectors.toList());
        } catch (Exception e) {
            LOG.error("While searching in Elasticsearch", e);
