...
public class ServerWebExchangeFrameworkAdapter extends DefaultFrameworkAdapter {
    ...
    public void applyDefaultSettingsIfUndefined(final Config config) {
        ...
        config.setWebContextFactoryIfUndefined(ServerWebExchangeContextFactory.INSTANCE);
        config.setSessionStoreFactoryIfUndefined(NoOpSessionStoreFactory.INSTANCE);
        config.setHttpActionAdapterIfUndefined(ServerWebExchangeHttpActionAdapter.INSTANCE);
    }
