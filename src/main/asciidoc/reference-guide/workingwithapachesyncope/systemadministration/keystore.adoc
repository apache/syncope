...
https://github.com/apache/syncope/blob/2_1_X/ext/saml2sp/common-lib/src/main/java/org/apache/syncope/common/lib/types/SignatureAlgorithm.java[available values^],
endif::[]
