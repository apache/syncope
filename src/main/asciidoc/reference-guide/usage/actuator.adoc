...
Besides a number of https://docs.spring.io/spring-boot/3.5/reference/actuator/endpoints.html[built-in endpoints^],
...
| `entityCache`
a| Allows to work with https://openjpa.apache.org/builds/4.1.1/apache-openjpa/docs/ref_guide_caching.html#ref_guide_cache_statistics[JPA cache statistics^]
...
| `gateway`
| https://docs.spring.io/spring-cloud-gateway/reference/4.3/spring-cloud-gateway-server-webflux/actuator-api.html[More details^]
