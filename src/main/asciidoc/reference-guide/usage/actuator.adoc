...
Besides a number of https://docs.spring.io/spring-boot/3.3/reference/actuator/endpoints.html[built-in endpoints^],
...
| `gateway`
| https://docs.spring.io/spring-cloud-gateway/docs/4.1.x/reference/html/#actuator-api[More details^]
