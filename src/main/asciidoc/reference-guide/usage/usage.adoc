...
https://syncope.apache.org/docs/4.1/getting-started.html[Apache Syncope Getting Started Guide]
endif::[]
ifeval::["{backend}" == "pdf"]
https://syncope.apache.org/docs/4.1/getting-started.pdf[Apache Syncope Getting Started Guide]
endif::[]
