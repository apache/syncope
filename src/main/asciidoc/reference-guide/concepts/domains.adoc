...
Each <<secure-remote-access>> and <<web-access>> instance is configured to bind to a given domain. +
This allows to provide segregated configuration for all access-related features.
