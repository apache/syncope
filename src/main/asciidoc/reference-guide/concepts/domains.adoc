...
https://apereo.github.io/cas/7.3.x/multitenancy/Multitenancy-Overview.html[CAS tenant^] having the same identifier; this
allows for <<web-access>> configuration to relate only to the given domain's database instance.
