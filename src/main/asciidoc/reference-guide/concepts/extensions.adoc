...
https://github.com/apache/syncope/tree/2_1_X/ext/camel[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/2_1_X/ext/swagger-ui[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/2_1_X/ext/saml2sp[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/2_1_X/ext/oidcclient[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/2_1_X/ext/elasticsearch[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/2_1_X/ext/scimv2[source tree^]
endif::[]
.
====
