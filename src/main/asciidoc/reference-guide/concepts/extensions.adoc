...
<<persistence,persistence>> of additional entities, extend the <<security-layer,security>> mechanisms, tweak the
...
https://github.com/apache/syncope/tree/4_0_X/ext/saml2sp4ui[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/4_0_X/ext/oidcc4ui[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/4_0_X/ext/elasticsearch[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/4_0_X/ext/opensearch[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/4_0_X/ext/scimv2[source tree^]
endif::[]
.
====
...
ifeval::["{snapshotOrRelease}" == "snapshot"]
https://github.com/apache/syncope/tree/4_0_X/ext/openfga[source tree^]
endif::[]
.
====
