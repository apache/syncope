...
https://apereo.github.io/cas/7.3.x/integration/Attribute-Release-PrincipalId-Attribute.html[CAS Attribute-based Principal Id^]
...
https://apereo.github.io/cas/7.3.x/services/Service-Management.html[CAS Services^].
