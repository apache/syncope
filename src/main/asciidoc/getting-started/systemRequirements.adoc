...
Apache Syncope {docVersion} requires the latest JDK 11 that is available. Works with JDK 17.
...
Apache Syncope {docVersion} is verified with the recent versions of the following DBMSes, for internal storage:
 ...
 . http://www.microsoft.com/en-us/server-cloud/products/sql-server/[MS SQL Server^] (>= 2017, JDBC driver >= {sqlserverJDBC}11)
