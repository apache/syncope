...
$ cd /usr/share/tomcat8/lib/ && sudo wget https://repo1.maven.org/maven2/org/postgresql/postgresql/{postgresqlJDBC}/postgresql-{postgresqlJDBC}.jar
+
...
OpenJPA for
http://openjpa.apache.org/builds/2.4.3/apache-openjpa/docs/ref_guide_event.html[remote event notification^] including
