 ...
 */
public class ActionResultModalPage<T, S> extends BaseModalPage {
    ...
    public ActionResultModalPage(
        ...
        final List<IColumn<T, S>> newColumnList = new ArrayList<IColumn<T, S>>(columns.subList(1, columns.size()));
