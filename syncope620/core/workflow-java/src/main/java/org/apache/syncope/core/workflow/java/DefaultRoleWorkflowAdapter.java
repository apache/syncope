...
public class DefaultRoleWorkflowAdapter extends AbstractRoleWorkflowAdapter {

    @Override
    public WorkflowResult<Long> create(final RoleTO roleTO) throws WorkflowException {
        ...
        return new WorkflowResult<>(role.getKey(), propByRes, "create");
    }

    @Override
    protected WorkflowResult<Long> doUpdate(final Role role, final RoleMod roleMod)
    ...
    @Override
    protected void doDelete(final Role role)
            throws WorkflowException {
    ...
    @Override
    public WorkflowResult<Long> execute(RoleTO roleTO, String taskId)
